...
node yb-fallback-star-1.js > $ARTIFACTS_PATH/yb-fallback-star-1.txt 2>&1

echo "Test 1 (yb-fallback-star-1) completed"

node yb-fallback-star-2.js > $ARTIFACTS_PATH/yb-fallback-star-2.txt 2>&1

echo "Test 2 (yb-fallback-star-2) completed"

node yb-fallback-test-1.js > $ARTIFACTS_PATH/yb-fallback-test-1.txt 2>&1

echo "Test 3 (yb-fallback-test-1) completed"

node yb-fallback-test-2.js > $ARTIFACTS_PATH/yb-fallback-test-2.txt 2>&1

echo "Test 4 (yb-fallback-test-2) completed"

node yb-fallback-test-2.js > $ARTIFACTS_PATH/yb-fallback-test-3.txt 2>&1

echo "Test 5 (yb-fallback-test-2) completed"

node yb-fallback-topology-aware-1 > $ARTIFACTS_PATH/yb-fallback-topology-aware-1.txt 2>&1

echo "Test 6 (yb-fallback-topology-aware-1) completed"

node yb-fallback-topology-aware-2.js > $ARTIFACTS_PATH/yb-fallback-topology-aware-2.txt 2>&1

echo "Test 7 (yb-fallback-topology-aware-2) completed"

node yb-fallback-topology-aware-3.js > $ARTIFACTS_PATH/yb-fallback-topology-aware-3.txt 2>&1

echo "Test 8 (yb-fallback-topology-aware-3) completed"

node yb-load-balance-with-add-node.js > $ARTIFACTS_PATH/yb-load-balance-with-add-node.txt 2>&1

echo "Test 9 (yb-load-balance-with-add-node) completed"

node yb-load-balance-with-stop-node.js > $ARTIFACTS_PATH/yb-load-balance-with-stop-node.txt 2>&1

echo "Test 10 (yb-load-balance-with-stop-node) completed"

node yb-pooling-with-load-balance.js > $ARTIFACTS_PATH/yb-pooling-with-load-balance.txt 2>&1

echo "Test 11 (yb-pooling-with-load-balance) completed"

node yb-pooling-with-topology-aware.js > $ARTIFACTS_PATH/yb-pooling-with-topology-aware.txt 2>&1

echo "Test 12 (yb-pooling-with-topology-aware) completed"

node yb-topology-aware-with-add-node.js > $ARTIFACTS_PATH/yb-topology-aware-with-add-node.txt 2>&1

echo "Test 13 (yb-topology-aware-with-add-node) completed"

node yb-topology-aware-with-stop-node.js > $ARTIFACTS_PATH/yb-topology-aware-with-stop-node.txt 2>&1
