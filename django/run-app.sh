...
do
   ...
   echo "==========================================================================================="
   python3 runtests.py --settings=test_yugabyte -v 3 $DJANGO_TEST_APP --noinput --debug-sql || EXIT_STATUS=$?
done
